...
int main() {
	...
	//fcircuit(f,h,n_ele);
	fcircuit(Slinks *Link[Nlinks] , int Nlinks);
	} else{
...
//********************************************************************************************************************
void fcircuit(Slink *Link[Nlinks] , int Nlinks){
//void fcircuit(int f[], int h[], int Nlinks) {
	...
	fmax = max_array(f, Nlinks); // max of array f
	hmax = max_array(h, Nlinks); //max of array h
